...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        //print(text.count - 5)
        //print(text[text.index(text.startIndex, offsetBy: 1)...text.index(text.startIndex, offsetBy: text.count - 5)])
        ecverify()
...
//        print("BKX token balance = " + String(bal))
    ...
    func ecverify()-> String? {
        ...
        //let web3rin = Web3.new(URL(string: "http://153.126.153.29:4444")!)
        let web3rin = Web3.new(URL(string: "http://127.0.0.1:8545")!)
        let balanceResult = web3rin?.eth.getBalance(address: address!)
        ...
        let contract = web3rin?.contract(abi, at: contractAddress, abiVersion: 1)!
        var options = Web3Options.defaultOptions()
        var gasLimit: BigUInt? = BigUInt(5000000000000) // - default gas limit
        var gasPrice: BigUInt? = BigUInt(5000000000000) // - default gas price, quite small
        options.gasLimit = gasLimit
        ...
        //var msg_hex:String = "0x8fc1fedd35837f0fb69fb9e422316"
        //print(msg_hex)
//        let msg_hex:String = "0x8fc1fedd35837f0fb69fb9e4223161c0ac1abe7813dd565a10034d27ff7fb68b"
